            ...
            <div className='mt-2 gap-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6' >
                {addedPhotos.length > 0 && addedPhotos.map(link => (
                    <div className='h-32 flex relative' key={link} >
                        ...
                        <button onClick={(e) => removePhoto(e, link)} className='absolute bottom-2 right-2 text-white bg-red-600 bg-opacity-50 rounded-2xl p-1' >
                ...
                <label className='h-32 flex cursor-pointer items-center gap-1 justify-center border bg-transparent rounded-2xl p-8 text-2xl text-gray-600' >
